            ...
            <section className='2xl:h-[84rem] 3xl:h-[134rem] xl:h-[140rem] flex items-center justify-center flex-col mt-[62rem] lg:mt-[39rem] xl:mt-[50rem] 2xl:mt-[55rem] 3xl:mt-[90rem] bg-custom-cyan'>
                <div className='flex items-center justify-center flex-col'>
                    <div className='text-center mb-12'>
                        <h1 className='text-3xl font-bold mb-2 md:text-5xl 3xl:text-9xl mb-10'>Awards</h1>
                        <h2 className='text-xl md:text-2xl font-normal 3xl:text-4xl mt-15'>Awards Schemes and Categories</h2>
                    </div>
<div className='flex md:gap-40 md:text-center gap-6 xl:gap-28 px-4 mx-auto items-center justify-center 2xl:gap-7 3xl:gap-20'>                        <div className='w-full shadow-button-c flex flex-wrap shadow-md bg-white h-96 gap-14 rounded-md  text-custom-blue md:w-72 lg:w-96 xl:w-[38rem] xl:h-[35rem] 2xl:w-[35rem] 3xl:w-[45rem] 3xl:h-[49rem]'>
            ...
            <section className='relative flex flex-col items-center justify-center'>
                ...
                <div className='absolute flex items-center justify-center flex-col text-center text-white'>
                    ...
                    <a href="https://www.linkedin.com/in/enow-john-1abb95296/">  <button className='px-4 py-2 bg-custom-blue text-white rounded-md w-36 h-10 3xl:w-[25rem] 3xl:h-16 3xl:text-3xl 2xl:w-[20rem] 2xl:text-2xl 2xl:h-14'>Contact Us</button></a>                    
                </div>
            </section>
